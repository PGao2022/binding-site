...
class UNet(Model):
    ...
    def __init__(self, inputs=None, outputs=None, data_handle=None,
        ...
        if featurizer is not None:
            if not isinstance(featurizer, tfbio1.data.Featurizer):
    ...
    def load_model(path, **attrs):
        ...
        if 'data_handle' in attrs:
            ...
            if 'featurizer' in attrs:
                if not (isinstance(attrs['featurizer'], tfbio1.data.Featurizer)):
                    raise TypeError(
                        'featurizer should be a tfbio1.data.Featurizer object, '
    ...
    def pocket_density_from_mol(self, mol):
        ...
        x = tfbio1.data.make_grid(prot_coords, prot_features,
