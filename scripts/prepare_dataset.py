...
import json
import sys
sys.path.append('/Users/gaopeijun/kalasanty/')

from kalasanty.data import prepare_dataset
from tfbio1.data import Featurizer
...
def main():
    ...
    protein_featurizer = Featurizer(save_molecule_codes=False, custom_properties = [encode_residue])
